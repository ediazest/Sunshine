 ...
 */
package edu.android.com.sunshine.data;
...
import edu.android.com.sunshine.data.WeatherContract.LocationEntry;
import edu.android.com.sunshine.data.WeatherContract.WeatherEntry;
...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        sURIMatcher.addURI(contentAuthority, WeatherContract.PATH_WEATHER, WEATHER);
        sURIMatcher.addURI(contentAuthority, WeatherContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        sURIMatcher.addURI(contentAuthority, WeatherContract.PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        sURIMatcher.addURI(contentAuthority, WeatherContract.PATH_LOCATION, LOCATION);
